...
from INI_Configuration import INI_Configuration
...
class Gui_auxiliary_app(tk.Tk):
    ...
    def on_continue(self):
        ...
        self.selected_file =  os.path.join(dir, "conf-combination-video-data.ini") 
    ...
    def create_dict_parameters(file, movie_path, dir):
      ...
      excel_left = os.path.join(dir, filename + "_with_landmarks_left.xlsx")
      excel_right = os.path.join(dir, filename + "_with_landmarks_right.xlsx")
      video_final = os.path.join(dir, filename + "_with_landmarks_audio_graphs.mp4")
      
      INI_Configuration(movie_path,video_output,excel_left, excel_right, video_final,file)
