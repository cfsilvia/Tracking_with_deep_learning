...
class Gui_auxiliary_app(tk.Tk):
    ...
    def create_dict_parameters(file, movie_path, dir):
      ...
      config = {
        ...
        "side_to_track" : "right", #options: right, left, both
        "x_crop" : 912, #crop the video in x direction (e.g. 100 will crop 100 pixels from the left and 100 pixels from the right)
    }
